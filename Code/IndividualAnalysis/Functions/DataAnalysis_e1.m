function newST = DataAnalysis_e1(ST,T)
...
%         bslLSL = mean(LSLtrue(end-49:end));
    ...
    clear LSL LSLdataSample Success Trgt_prct Trgt_SL TrgtHi_SL TrgtLo_SL LSL_kin RSL_kin SLA AveVel_left PeakVel_left tempT StrideNum
