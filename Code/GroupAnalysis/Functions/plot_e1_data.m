function anova_T = plot_e1_data(T)

%Define phases and subjects
...
rectangle('Position',[sum(short_phase(1:2))-50, -3, 50, 20],'FaceColor','none','EdgeColor','k','LineStyle','-','LineWidth',1);
rectangle('Position',[sum(short_phase(1:2))+1, -3, 30, 20],'FaceColor','none','EdgeColor','k','LineStyle','-','LineWidth',1);
rectangle('Position',[stable_idx(1), -3, 50, 20],'FaceColor','none','EdgeColor','k','LineStyle','-','LineWidth',1);
...
ylabel('Aftereffect (%)','FontSize',18,'FontName','Ariel', 'FontWeight','normal');
